...
if uploaded_file is not None:
   # Read the CSV file into a Pandas dataframe
    ...
    if st.button("Submit"):
        ...
        anonymized_data = pd.concat(generalized_data)[ generalize_cols
            # ['User Id','Name','Tweet Location', 'User Followers', 'User Following', 'User Account Creation Date', 'Tweet Content', 'Tweet Posted Time (UTC)']
                                                    ]
